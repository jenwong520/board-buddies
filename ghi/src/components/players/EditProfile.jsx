        ...
        <>
            < Nav />
                <div className="card" style={{ backgroundColor: 'rgba(47, 47, 47, 0.8)', color: 'white', marginBottom: '15%' }}>
                    <div className="edit-profile-page container mt-4">
                        ...
                        {/* Edit Profile Title Banner */}
                        <div className="text-center mb-4">
                            <h1 className="display-4" style={{ color: '#f8f9fa' }}>Edit Profile</h1>
                            <hr style={{ width: '50%', margin: 'auto', backgroundColor: '#f8f9fa' }} />
                        </div>

                        {/* Left Column with Profile Picture and Editable Username */}
